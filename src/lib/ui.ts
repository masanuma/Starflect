...
const UI: Record<Lang, UIStrings> = {
  ja: {
    ...
    result: {
      ...
      partySub: '生まれた瞬間の星たちが、あなたを動かすキャラになりました。それぞれの担当と特徴です。',
  ...
  en: {
    ...
    result: {
      ...
      partySub: 'The stars at the moment you were born became the characters that move you—here’s what each one handles, and what it’s like.',
  ...
  es: {
    ...
    result: {
      ...
      partySub: 'Los astros del momento de tu nacimiento se volvieron los personajes que te mueven: de qué se encarga cada uno y cómo es.',
  ...
  fr: {
    ...
    result: {
      ...
      partySub: 'Les astres de l’instant de ta naissance sont devenus les personnages qui te font avancer : ce dont chacun s’occupe et son caractère.',
  ...
  it: {
    ...
    result: {
      ...
      partySub: 'Gli astri dell’istante della tua nascita sono diventati i personaggi che ti muovono: di cosa si occupa ognuno e com’è fatto.',
  ...
  pt: {
    ...
    result: {
      ...
      partySub: 'Os astros do instante do seu nascimento viraram os personagens que movem você: do que cada um cuida e como ele é.',
  ...
  ko: {
    ...
    result: {
      ...
      partySub: '태어난 순간의 별들이 당신을 움직이는 캐릭터가 되었어요. 각자의 담당과 특징이에요.',
