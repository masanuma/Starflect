...
const UI: Record<Lang, UIStrings> = {
  ...
  en: {
    ...
    result: {
      ...
      partyTitle: (n) => `The ${n} stars that move you`,
  ...
  es: {
    ...
    result: {
      ...
      partyTitle: (n) => `Los ${n} astros que te mueven`,
  ...
  fr: {
    ...
    result: {
      ...
      partyTitle: (n) => `Les ${n} astres qui te font avancer`,
  ...
  it: {
    ...
    result: {
      ...
      partyTitle: (n) => `I ${n} astri che ti muovono`,
  ...
  pt: {
    ...
    result: {
      ...
      partyTitle: (n) => `Os ${n} astros que movem você`,
