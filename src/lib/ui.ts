...
const UI: Record<Lang, UIStrings> = {
  ...
  fr: {
    ...
    home: {
      ...
      seeCompanion: (name) => `Retrouver ${name}`,
    },
    faq: {
  ...
  pt: {
    ...
    home: {
      ...
      seeCompanion: (name) => `Visitar ${name}`,
    },
    faq: {
