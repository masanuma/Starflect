...
const UI: Record<Lang, UIStrings> = {
  ja: {
    ...
    companion: {
      ...
      readingHeading: 'あなたのほしキャラが読む、運勢',
      readsIntro: (name) => `${name}です。今の星の巡りを読みました。`,
  ...
  en: {
    ...
    companion: {
      ...
      readsIntro: (name) => `I’m ${name}. I’ve read the current stars for you.`,
  ...
  es: {
    ...
    companion: {
      ...
      readsIntro: (name) => `Soy ${name}. He leído las estrellas de ahora para ti.`,
  ...
  fr: {
    ...
    home: {
      ...
      soloName: '🌟 Hoshi-Kyara',
      soloTime: '30 s',
      soloDesc: 'Juste ta date de naissance. On analyse ton Hoshi-Kyara (1 sur 16) et les 10 planètes-personnages qui vivent en toi.',
    ...
    result: {
      ...
      partyTitle: 'L’équipe derrière ton Hoshi-Kyara',
      partySub: 'Les astres de l’instant de ta naissance sont devenus les personnages qui te font avancer. Voici le domaine de chacun et sa façon de s’exprimer aujourd’hui.',
      domain: 'Domaine',
      quirk: 'Style',
      genBadge: 'Génér.',
    ...
    chat: {
      ...
      hide: 'Masquer',
      show: 'Afficher',
      intro: 'Demande ce qui te préoccupe. Amour, travail, personnalité, l’avenir — on répond à partir de tes 10 planètes et du ciel actuel.',
    ...
    footer: 'Tous les calculs astraux se font sur ton propre appareil. Ce n’est qu’en choisissant « Obtenir une lecture IA détaillée » que les résultats sont envoyés à l’IA.',
    consent: {
    ...
    companion: {
      ...
      readsIntro: (name) => `Je suis ${name}. J’ai lu les étoiles du moment pour toi.`,
  ...
  it: {
    ...
    home: {
      ...
      soloName: '🌟 Hoshi-Kyara',
      soloTime: '30 s',
      soloDesc: 'Basta la tua data di nascita. Analizziamo il tuo Hoshi-Kyara (1 su 16) e i 10 pianeti-personaggio che vivono in te.',
    ...
    result: {
      ...
      partyTitle: 'Il gruppo dietro il tuo Hoshi-Kyara',
      partySub: 'Gli astri dell’istante della tua nascita sono diventati i personaggi che ti muovono. Ecco l’ambito di ognuno e come si manifesta ora.',
      domain: 'Ambito',
      quirk: 'Stile',
      genBadge: 'Gen',
    ...
    chat: {
      ...
      hide: 'Nascondi',
      show: 'Mostra',
      intro: 'Chiedi ciò che ti sta a cuore. Amore, lavoro, personalità, il futuro — rispondiamo dai tuoi 10 pianeti e dal cielo attuale.',
    ...
    footer: 'Tutti i calcoli astrali avvengono sul tuo dispositivo. Solo scegliendo « Ottieni una lettura IA dettagliata » i risultati vengono inviati all’IA.',
    consent: {
    ...
    companion: {
      ...
      readsIntro: (name) => `Sono ${name}. Ho letto le stelle di adesso per te.`,
  ...
  pt: {
    ...
    home: {
      ...
      soloName: '🌟 Hoshi-Kyara',
      soloTime: '30 s',
      soloDesc: 'Só a sua data de nascimento. Analisamos o seu Hoshi-Kyara (1 de 16) e os 10 planetas-personagem que vivem em você.',
    ...
    result: {
      ...
      partyTitle: 'O grupo por trás do seu Hoshi-Kyara',
      partySub: 'Os astros do instante do seu nascimento viraram os personagens que movem você. Aqui está a área de cada um e como se manifesta agora.',
      domain: 'Área',
      quirk: 'Estilo',
      genBadge: 'Ger.',
    ...
    chat: {
      ...
      hide: 'Ocultar',
      show: 'Mostrar',
      intro: 'Pergunte o que quiser. Amor, trabalho, personalidade, o que vem aí — respondemos a partir dos seus 10 planetas e do céu atual.',
    ...
    footer: 'Todos os cálculos astrais acontecem no seu próprio dispositivo. Só ao escolher « Obter uma leitura IA detalhada » os resultados são enviados à IA.',
    consent: {
    ...
    companion: {
      ...
      readsIntro: (name) => `Sou ${name}. Li as estrelas de agora para você.`,
  ...
  ko: {
    ...
    home: {
      ...
      soloName: '🌟 Hoshi-Kyara',
      soloTime: '30초',
      soloDesc: '생년월일만 있으면 OK. 당신의 Hoshi-Kyara(16종 중 하나)와 당신 안에 사는 10행성 캐릭터까지 분석해요.',
      pairName: '💞 궁합',
    ...
    result: {
      ...
      partyTitle: 'Hoshi-Kyara를 이루는 파티',
      partySub: '태어난 순간의 별들이 당신을 움직이는 캐릭터가 되었어요. 각자의 담당과 지금의 발휘 방식이에요.',
      domain: '담당',
      quirk: '스타일',
      genBadge: '세대',
    ...
    chat: {
      ...
      hide: '숨기기',
      show: '보기',
      intro: '궁금한 걸 물어보세요. 연애·일·성격·앞으로의 운세——당신의 10행성과 지금의 별자리를 바탕으로 답해 드려요.',
    ...
    footer: '별 계산은 모두 사용 중인 기기 안에서 이루어져요. 「AI에게 자세히 점쳐 보기」를 선택했을 때만 계산 결과가 AI로 전송돼요.',
    consent: {
    ...
    companion: {
      ...
      readsIntro: (name) => `${name}입니다. 지금의 별의 흐름을 읽어 봤어요.`,
