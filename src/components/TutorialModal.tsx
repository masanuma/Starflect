...
const TutorialModal: React.FC<TutorialModalProps> = ({ isOpen, onClose }) => {
  ...
  const tutorialSteps = [
    ...
    {
      title: "🌙 衝撃の事実：月星座があった！",
      content: "実は「月星座」というものもあるんです！\n\n月は約2時間で星座が変わるので、同じ日に生まれても朝と夜では月星座が違います。\n\nこれが「本当の感情やプライベートな自分」を表すんです。",
      image: "🌙",
      highlight: ""
    },
    {
      title: "🌅 さらに驚き：上昇星座まで！",
      content: "なんと「上昇星座」というものもあります！\n\n上昇星座は4分で1度変わるので、出生時刻で「人から見た印象」が決まります。\n\n同じ誕生日でも、生まれた時刻で全然違う印象になるんです。",
      image: "🌅",
      highlight: ""
    },
    {
      title: "🌌 もっと衝撃：星は10個もあった！",
      content: "実は占いで使う星は10個もあるんです！\n太陽・月・水星・金星・火星・木星・土星・天王星・海王星・冥王星。\n\nそれぞれが違う星座にいて、あなたの性格の違う面を表しています。",
      image: "🌌",
      highlight: ""
    },
    {
      title: "😲 だから数百万通りになる！",
      content: "これで謎が解けました！\n\n普通の星座占い：太陽星座だけ（12種類）\nStarflect：10個の星の組み合わせ（数百万通り）\n\nだからあなただけの詳しい占い結果が分かるんです！",
      image: "💡",
      highlight: ""
    },
    {
