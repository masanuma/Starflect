...
丁寧な日本語（「です・ます」調、敬語、親しみやすい語尾）で、やさしく分かりやすく解説してください。
...
{
  "personalityInsights": {
    "corePersonality": "太陽星座の特徴を50文字以上で、丁寧な日本語でやさしく解説してください。",
    "hiddenTraits": "月星座の隠れた特性を50文字以上で、丁寧な日本語でやさしく解説してください。",
    "lifePhilosophy": "人生哲学や価値観を50文字以上で、丁寧な日本語でやさしく解説してください。",
    "relationshipStyle": "人間関係のスタイルを50文字以上で、丁寧な日本語でやさしく解説してください。",
    "careerTendencies": "キャリア傾向を50文字以上で、丁寧な日本語でやさしく解説してください。"
  },
  "detailedFortune": {
    "overallTrend": "全体的な運勢傾向を50文字以上で、丁寧な日本語でやさしく解説してください。",
    "loveLife": "恋愛運を50文字以上で、丁寧な日本語でやさしく解説してください。",
    "careerPath": "仕事運を50文字以上で、丁寧な日本語でやさしく解説してください。",
    "healthWellness": "健康運を50文字以上で、丁寧な日本語でやさしく解説してください。",
    "financialProspects": "金運を50文字以上で、丁寧な日本語でやさしく解説してください。",
    "personalGrowth": "成長運を50文字以上で、丁寧な日本語でやさしく解説してください。"
  }
}
...
以下の出生データと天体情報をもとに、要点のみ簡潔に分析してください。
...
【出力形式】
必ず以下のJSON形式のみで回答してください。キーは英語、値は日本語で記述してください。
{
  "signCharacteristics": "${planet.planet}星座の特徴を50文字以上で要点のみ簡潔に記述",
  "personalImpact": "あなたへの影響を50文字以上で要点のみ簡潔に記述",
  "advice": "具体的なアドバイスを50文字以上で要点のみ簡潔に記述"
}
...
クライアントの質問に対して、占星術師として丁寧に回答してください。
`;
